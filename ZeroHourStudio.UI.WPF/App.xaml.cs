...
namespace ZeroHourStudio.UI.WPF
{
    ...
    public partial class App : System.Windows.Application
    {
        ...
        public static void DiagLog(string message)
        {
            ...
            catch (Exception ex) { System.Diagnostics.Debug.WriteLine($"[App] DiagLog error: {ex.Message}"); }
        }
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            catch (Exception ex) { System.Diagnostics.Debug.WriteLine($"[App] Startup error: {ex.Message}"); }
        }
